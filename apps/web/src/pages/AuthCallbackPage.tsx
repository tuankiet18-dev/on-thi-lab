...
export function AuthCallbackPage() {
  ...
  const isLocked = message.toLowerCase().includes("khóa");

  return (
    <main className="grid min-h-screen place-items-center bg-app p-5">
      <section className="w-full max-w-md rounded-3xl border border-border bg-white p-8 text-center shadow-panel animate-in zoom-in-95">
        <span
        ...
        {state === "error" && (
          <button
            ...
            className="mt-6 min-h-11 cursor-pointer rounded-xl bg-primary px-5 py-2 font-bold text-white hover:bg-primary-strong transition shadow-sm"
          >
